<div id="modalContent" class="modal-content">
    <div class="modal-header">
        ...
        <h4><i class="fa fa-windows"></i>&nbsp;&nbsp;&nbsp;RESET MẬT KHẨU HÒM ĐỒ</h4>
    </div>
    <div class="modal-body">
        <form action="<?= base_url('Member/ResetInventoryPass') ?>" autocomplete="off" class="form-horizontal" id="mainForm" method="post" novalidate="novalidate">
            <div class="alert alert-info">
                Vui lòng nhập email đã đăng ký để tiến hành reset mật khẩu hòm đồ
            </div>
