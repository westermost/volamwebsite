<div id="modalContent" class="modal-content">
    ...
    <div class="modal-body">
        <form action="<?= base_url('Admin/EditGift') ?>" autocomplete="off" class="form-horizontal" id="mainForm" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" data-val="true" data-val-required="Mã vật phẩm không được để trống" id="ItemID" name="ItemID" placeholder="Mã vật phẩm" type="text" value="<?= $giftInfo['gift_id'] ?>" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" data-val="true" data-val-required="Tên vật phẩm không được để trống" id="ItemName" name="ItemName" placeholder="Tên vật phẩm" type="text" value="<?= $giftInfo['Name'] ?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="Point">Số điểm</label>
                    <div class="col-sm-8">
                        <input class="form-control" data-val="true" data-val-required="Số điểm không được để trống" id="Point" name="Point" placeholder="Số điểm nhận quà" type="text" value="<?= $giftInfo['Point'] ?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="quantity">Số lượng</label>
                    <div class="col-sm-8">
                        <input class="form-control" data-val="true" data-val-required="Số lượng không được để trống" id="quantity" name="quantity" placeholder="Số lượng vật phẩm" type="text" value="<?= $giftInfo['quantity'] ?>" />
                    </div>
                </div>
                <div class="form-group">
