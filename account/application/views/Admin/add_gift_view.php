<div id="modalContent" class="modal-content">
    <div class="modal-header">
        ...
        <h4><i class="fa fa-windows"></i>&nbsp;&nbsp;&nbsp;TẠO MỚI QUÀ TẶNG</h4>
    </div>
    <div class="modal-body">
        <form action="<?= base_url('Admin/AddGift') ?>" autocomplete="off" class="form-horizontal" id="mainForm" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" data-val="true" data-val-required="Số điểm không được để trống" id="Point" name="Point" placeholder="Số điểm nhận quà" type="text" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="quantity">Số lượng</label>
                    <div class="col-sm-8">
                        <input class="form-control" data-val="true" data-val-required="Số lượng không được để trống" id="quantity" name="quantity" placeholder="Số lượng vật phẩm" type="text" />
                    </div>
                </div>
                <div class="form-group">
