<div id="modalContent" class="modal-content">
    <div class="modal-header">
        ...
        <h4><i class="fa fa-windows"></i>&nbsp;&nbsp;&nbsp;XÓA GIFT ITEM</h4>
    </div>
    <div class="modal-body">
        <form action="<?= base_url('Admin/DelGiftItem') ?>" autocomplete="off" class="form-horizontal" id="mainForm" method="post">
                <div id="formMessage" class="alert alert-danger">Bạn có chắc muốn xóa gift item này?</div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" data-val="true" data-val-required="Mã vật phẩm không được để trống" id="ItemID" name="ItemID" placeholder="Mã vật phẩm" value="<?= $giftItemInfo['ItemID'] ?>" type="text" disabled />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="ItemName">Tên vật phẩm</label>
                    <div class="col-sm-8">
                        <input class="form-control" data-val="true" data-val-required="Tên vật phẩm không được để trống" id="ItemName" name="ItemName" placeholder="Tên vật phẩm" value="<?= $giftItemInfo['ItemName'] ?>" type="text" disabled />
                    </div>
