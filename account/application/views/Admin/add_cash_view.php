                    ...
                    <div class="col-md-12">
                        <div class="ibox">
                            ...
                            <div class="ibox-content">
                                <form action="<?= base_url('Admin/AddCash') ?>" autocomplete="off" class="form-horizontal" id="addCashForm" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control" placeholder="0" id="Cash" name="Cash" type="number" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" for="Value">Phần Trăm Khuyến Mãi Cộng Thêm</label>
                                        <div class="col-sm-6">
                                            <input class="form-control" placeholder="Nhập tỉ lệ Bonus" id="Value" name="Value" type="text" value="0.1" />
                                        </div>
